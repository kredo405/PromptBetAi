export const generateAiPrompt = (
    ...
    return `
Проанализируй все предоставленые данные и Выбери лучшую ставку на матч между командами ${teamHome} и ${teamAway}. Учти следующие данные точного прогнозирования:
